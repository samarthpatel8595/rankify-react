...
export default function CreateEventPage() {
  return (
    <div className="p-2 space-y-6">
      ...
      {/* ===== CARD 1 ===== */}
      <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 mb-6 shadow-sm">
      ...
      <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm">
        ...
        <div className="bg-[#F3F4F6] border border-[#E5E7EB] rounded-md p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-y-1 text-[11px] text-[#374151]">
        ...
        {/* DOWNLOAD */}
        <div className="flex gap-6 mt-4 text-[11px] text-[#D4A017]">
